define([
  ...
  app.factory('toasty', ['$rootScope', 'toastyConfig', function($rootScope, toastyConfig) {
  ...
  .provider('toastyConfig', function() {
  ...
  .directive('toasty', ['toasty', '$timeout', '$sce', function(toasty, $timeout, $sce) {
    return {
      replace: true,
      restrict: 'EA',
      scope: true,
